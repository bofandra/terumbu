...
const ids = {
  ...
  campaignActivityRajaUpdate: "55555555-5555-4555-8555-555555555561",
  campaignActivityBaliUpdate: "55555555-5555-4555-8555-555555555562",
  campaignActivityKomodoUpdate: "55555555-5555-4555-8555-555555555563",
  campaignActivityRajaBefore: "55555555-5555-4555-8555-555555555564",
  campaignActivityRajaEvidence: "55555555-5555-4555-8555-555555555565",
  campaignActivityBaliBefore: "55555555-5555-4555-8555-555555555566",
...
async function seed() {
    ...
    .values([
      {
        ...
        arrivalHubs: [{ type: "airport", name: "Domine Eduard Osok Airport, Sorong", code: "SOQ" }, { type: "city", name: "Sorong", code: "" }],
        bestMonths: [],
      ...
      },
      {
        ...
        arrivalHubs: [{ type: "airport", name: "I Gusti Ngurah Rai International Airport", code: "DPS" }],
        bestMonths: [],
      ...
      },
      {
        ...
        arrivalHubs: [{ type: "airport", name: "Komodo Airport, Labuan Bajo", code: "LBJ" }, { type: "city", name: "Labuan Bajo", code: "" }],
        bestMonths: [],
      ...
      },
      {
        ...
        arrivalHubs: [{ type: "airport", name: "Zainuddin Abdul Madjid International Airport", code: "LOP" }],
        bestMonths: [],
  ...
  await db
    ...
    .values([
      {
        id: ids.campaignActivityRajaUpdate,
        campaignId: campaignBySlug.get("restore-raja-ampat-reefs")!,
        sourceUpdateId: ids.campaignUpdateRajaAmpat,
        activityCode: "ACT-SEED-UPD-RAJA",
        title: "First coral table batch installed",
        body: "Field teams installed the first restoration tables and tagged the demo cohort for monthly monitoring.",
        activityType: "field_note",
        mediaUrl: "https://images.unsplash.com/photo-1583212292454-1fe6229603b7?auto=format&fit=crop&w=1200&q=80",
        visibilityStatus: "published",
        publishedAt: date("2026-06-11T03:00:00.000Z"),
        metadata: { seededFrom: "campaign_updates" },
        createdAt: date("2026-06-11T03:00:00.000Z")
      },
      {
        id: ids.campaignActivityBaliUpdate,
        campaignId: campaignBySlug.get("mangrove-shield-bali")!,
        sourceUpdateId: ids.campaignUpdateBali,
        activityCode: "ACT-SEED-UPD-BALI",
        title: "Nursery stock reached 18,400 seedlings",
        body: "Community nursery teams completed the second seedling audit and prepared the next volunteer planting block.",
        activityType: "field_note",
        ...
        publishedAt: date("2026-06-10T03:00:00.000Z"),
        metadata: { seededFrom: "campaign_updates" },
        createdAt: date("2026-06-10T03:00:00.000Z")
      },
      {
        id: ids.campaignActivityKomodoUpdate,
        campaignId: campaignBySlug.get("cleanup-komodo-coast")!,
        sourceUpdateId: ids.campaignUpdateKomodo,
        activityCode: "ACT-SEED-UPD-KOMODO",
        title: "School cleanup challenge launched",
        body: "Three island schools joined the coastal cleanup challenge and began tracking sorted waste by material type.",
        activityType: "field_note",
        mediaUrl: "https://images.unsplash.com/photo-1546026423-cc4642628d2b?auto=format&fit=crop&w=1200&q=80",
        visibilityStatus: "published",
        publishedAt: date("2026-06-08T03:00:00.000Z"),
        metadata: { seededFrom: "campaign_updates" },
        createdAt: date("2026-06-08T03:00:00.000Z")
      },
      {
        id: ids.campaignActivityRajaBefore,
        campaignId: campaignBySlug.get("restore-raja-ampat-reefs")!,
        sourceEvidenceId: ids.evidenceRajaAmpatBefore,
        impactSiteId: ids.impactSiteRajaAmpat,
        createdByUserId: demoUser.id,
        activityCode: "ACT-SEED-EVD-RAJA-000",
        title: "Raja Ampat reef baseline photo",
        body: "Baseline record before the first restoration table batch was installed.",
        activityType: "before_photo",
        mediaUrl: "https://images.unsplash.com/photo-1546026423-cc4642628d2b?auto=format&fit=crop&w=1200&q=80",
        evidenceType: "before_photo",
        visibilityStatus: "evidence_only",
        verificationStatus: "verified",
        storageProvider: "cloudflare_r2_ready",
        verifiedAt: date("2026-05-20T04:00:00.000Z"),
        metadata: { evidenceCode: "EVD-RAJA-AMPAT-REEF-000", seededFrom: "project_evidence" },
        createdAt: date("2026-05-20T04:00:00.000Z")
      },
      {
        id: ids.campaignActivityRajaEvidence,
        campaignId: campaignBySlug.get("restore-raja-ampat-reefs")!,
        sourceEvidenceId: ids.evidenceRajaAmpat,
        impactSiteId: ids.impactSiteRajaAmpat,
        createdByUserId: demoUser.id,
        activityCode: "ACT-SEED-EVD-RAJA-001",
        title: "Raja Ampat reef table survey",
        body: "Restoration tables are installed and the first demo coral cohort is tagged for monitoring.",
        activityType: "field_photo",
        mediaUrl: "https://images.unsplash.com/photo-1583212292454-1fe6229603b7?auto=format&fit=crop&w=1200&q=80",
        evidenceType: "field_photo",
        visibilityStatus: "evidence_only",
        verificationStatus: "verified",
        storageProvider: "cloudflare_r2_ready",
        verifiedAt: date("2026-06-12T04:00:00.000Z"),
        metadata: { evidenceCode: "EVD-RAJA-AMPAT-REEF-001", seededFrom: "project_evidence" },
        createdAt: date("2026-06-12T04:00:00.000Z")
      },
      {
        id: ids.campaignActivityBaliBefore,
        campaignId: campaignBySlug.get("mangrove-shield-bali")!,
        sourceEvidenceId: ids.evidenceBaliBefore,
        impactSiteId: ids.impactSiteBali,
        createdByUserId: demoUser.id,
        activityCode: "ACT-SEED-EVD-BALI-000",
        title: "North Bali shoreline baseline",
        body: "Baseline shoreline condition recorded before nursery transfer and planting blocks.",
        activityType: "before_photo",
        ...
        storageProvider: "cloudflare_r2_ready",
        verifiedAt: date("2026-05-18T04:00:00.000Z"),
        metadata: { evidenceCode: "EVD-BALI-MANGROVE-000", seededFrom: "project_evidence" },
        createdAt: date("2026-05-18T04:00:00.000Z")
      },
      {
        id: ids.campaignActivityBaliEvidence,
        campaignId: campaignBySlug.get("mangrove-shield-bali")!,
        sourceEvidenceId: ids.evidenceBali,
        impactSiteId: ids.impactSiteBali,
        createdByUserId: demoUser.id,
        activityCode: "ACT-SEED-EVD-BALI-001",
        title: "North Bali nursery audit",
        body: "Nursery audit confirmed planting stock and early survival indicators for the next coastal block.",
        ...
        storageProvider: "cloudflare_r2_ready",
        verifiedAt: date("2026-06-10T04:00:00.000Z"),
        metadata: { evidenceCode: "EVD-BALI-MANGROVE-001", seededFrom: "project_evidence" },
        createdAt: date("2026-06-10T04:00:00.000Z")
      },
      {
        id: ids.campaignActivityKomodoBefore,
        campaignId: campaignBySlug.get("cleanup-komodo-coast")!,
        sourceEvidenceId: ids.evidenceKomodoBefore,
        impactSiteId: ids.impactSiteKomodo,
        createdByUserId: demoUser.id,
        activityCode: "ACT-SEED-EVD-KOMODO-000",
        title: "Komodo cleanup route baseline",
        body: "Baseline coastal route photographed before school cleanup teams started sorting waste.",
        activityType: "before_photo",
        ...
        storageProvider: "cloudflare_r2_ready",
        verifiedAt: date("2026-05-24T04:00:00.000Z"),
        metadata: { evidenceCode: "EVD-KOMODO-CLEANUP-000", seededFrom: "project_evidence" },
        createdAt: date("2026-05-24T04:00:00.000Z")
      },
      {
        id: ids.campaignActivityKomodoEvidence,
        campaignId: campaignBySlug.get("cleanup-komodo-coast")!,
        sourceEvidenceId: ids.evidenceKomodo,
        impactSiteId: ids.impactSiteKomodo,
        createdByUserId: demoUser.id,
        activityCode: "ACT-SEED-EVD-KOMODO-001",
        title: "Komodo school cleanup launch",
        body: "School teams launched the first cleanup route and logged sorted waste by material type.",
        activityType: "field_report",
        mediaUrl: "https://images.unsplash.com/photo-1546026423-cc4642628d2b?auto=format&fit=crop&w=1200&q=80",
        evidenceType: "field_report",
        visibilityStatus: "evidence_only",
        verificationStatus: "in_review",
        storageProvider: "cloudflare_r2_ready",
        metadata: { evidenceCode: "EVD-KOMODO-CLEANUP-001", seededFrom: "project_evidence" },
        createdAt: date("2026-06-05T04:00:00.000Z")
      }
    ])
    .onConflictDoUpdate({
      target: campaignActivities.activityCode,
      set: {
        campaignId: sql`excluded.campaign_id`,
        sourceUpdateId: sql`excluded.source_update_id`,
        sourceEvidenceId: sql`excluded.source_evidence_id`,
        impactSiteId: sql`excluded.impact_site_id`,
        ...
        evidenceType: sql`excluded.evidence_type`,
        visibilityStatus: sql`excluded.visibility_status`,
        verificationStatus: sql`excluded.verification_status`,
        storageProvider: sql`excluded.storage_provider`,
        publishedAt: sql`excluded.published_at`,
        verifiedAt: sql`excluded.verified_at`,
